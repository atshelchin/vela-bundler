//! Telegram alert transport. The suppression rules (fingerprint,
//! normalization, bounded reason, message text) live in
//! `vela_relay_core::alert`; this module owns the HTTP client and the Redis
//! suppression slot.
...
use vela_relay_core::alert::{alert_fingerprint, executor_alert_text};
