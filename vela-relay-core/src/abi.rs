...
pub struct PackedOperation {
    ...
    pub sender: Address,
    pub call_data: Bytes,
    pub has_eip7702_authorization: bool,
...
pub fn handle_ops_calldata(operations: &[PackedUserOperation], beneficiary: Address) -> Bytes {
...
pub fn pimlico_simulate_handle_op_calldata(
...
pub fn get_nonce_calldata(sender: Address, user_operation_nonce: U256) -> Bytes {
